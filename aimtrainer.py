...
def end_screen(win, elapsed_time, targets_pressed, clicks):
    ...
    gameover_label = LABEL_FONT.render(f"GAME OVER", 1, "white")
    ...
    win.blit(gameover_label, (get_middle(gameover_label), (HEIGHT/2)-200))
    win.blit(time_label, (get_middle(time_label), (HEIGHT/2)-100))
    win.blit(speed_label, (get_middle(speed_label), (HEIGHT/2)))
    win.blit(hits_label, (get_middle(hits_label), (HEIGHT/2)+100))
    win.blit(accuracy_label, (get_middle(accuracy_label), (HEIGHT/2)+200))
